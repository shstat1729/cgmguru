...
#> 
#> fnd___> print(paste("Found", length(min_before$min_index), "minimum points"))
...
#> 
#> fnd___> print(paste("Found", length(large_min_before$min_index), "minimum points in larger dataset"))
