...
#> 
#> fnd___> # Find maximum glucose in next 2 hours
#> fnd___> max_after <- find_max_after_hours(example_data_5_subject, start_points, hours = 2)
#> 
#> fnd___> print(paste("Found", length(max_after$max_index), "maximum points"))
#> [1] "Found 1 maximum points"
#> 
#> fnd___> # Find maximum glucose in next 1 hour
#> fnd___> max_after_1h <- find_max_after_hours(example_data_5_subject, start_points, hours = 1)
#> 
...
#> 
#> fnd___> large_max_after <- find_max_after_hours(example_data_hall, large_start_points, hours = 2)
#> 
#> fnd___> print(paste("Found", length(large_max_after$max_index), "maximum points in larger dataset"))
