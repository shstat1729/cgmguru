...
mapping GRID episode starts to maxima within a 4-hour window and merging
grid and maxima information. This function prepares data for downstream
analysis by combining these results.
...
A tibble with transformed data containing columns (`id`, `grid_time`,
`grid_gl`, `maxima_time`, `maxima_gl`)
