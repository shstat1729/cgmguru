...
- **Sang Ho Park**. Author, maintainer.

- **Rosa Oh**. Author, contributor.

- **Sang-Man Jin**. Author, contributor.

## Citation

Source:
[`DESCRIPTION`](https://github.com/shstat1729/cgmguru/blob/main/DESCRIPTION)

Park SH, Oh R, Jin S (2026). *cgmguru: Advanced Continuous Glucose
Monitoring Analysis with High-Performance C++ Backend*. R package
version 1.1.0, <https://github.com/shstat1729/cgmguru>.
