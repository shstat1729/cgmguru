...
detect_all_events <- function(df, reading_minutes = NULL, sort_time = FALSE, inter_gap = 45, return_interpolated = FALSE, summary_metrics_source = "raw", sensor_wear_ndays = NULL) {
    .Call(`_cgmguru_detect_all_events`, df, reading_minutes, sort_time, inter_gap, return_interpolated, summary_metrics_source, sensor_wear_ndays)
}
